...
<div class="middle">
      <div id="login">
        ...
        <form  action="gd_login_page.php" method="POST">
          ...
          <fieldset class="clearfix">
            ...
            <p><span class="fa fa-lock"></span><input  type="password" name="password"  Placeholder="Password" required></p> <!-- JS because of IE support; better: placeholder="Password" -->
             ...
             <div>
                                ...
                                password?--></a></span>
                                <span style="width:50%; text-align:right;  display: inline-block;"><button type="submit" class="btn btn-danger">Submit</button></span>
                            </div>
...
<div class="clearfix"></div>
      ...
      <div class="logo">
           <img  class="mb-2"  src="logo.png" alt="logo" height="80%" width=80%>
           <h4 class="mt-1 text-primary">E-classroom</h4>
          <h6 class="mt-1 text-primary">Group discussion</h6>
          <div class="clearfix"></div>
      </div>
