...
if (isset($_POST['addComment'])) {
    ...
    if ($isReply != 'false') {
        $conn->query("INSERT INTO replies (comment, commentID, userID, createdOn) VALUES ('$comment', '$commentID', 36, NOW())");
        ...
        $conn->query("INSERT INTO comments (userID, comment, createdOn) VALUES (36,'$comment',NOW())");
